...
export const Settings = ({close}) => {
  ...
  return (
    <div>
      {accounts.map((account) => (
        ...
        onClick={() => {
          ...
          className={classNames(
            "py-3 px-4 w-full flex items-center text-left outline-none transition-colors",
            {
      ...
      <button className="py-3 px-4 text-left transition-colors hover:bg-[#eff3f41a] w-full font-bold text-[#e7e9ea] text-[15px] leading-5">
